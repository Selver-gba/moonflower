...
void fuse_render() {
    ...
    printk("FUSE_PRIVATE_KEY: %08x %08x %08x %08x\n", FUSE_CHIP_REGS->FUSE_PRIVATE_KEY[0], FUSE_CHIP_REGS->FUSE_PRIVATE_KEY[1], FUSE_CHIP_REGS->FUSE_PRIVATE_KEY[2], FUSE_CHIP_REGS->FUSE_PRIVATE_KEY[3]);
    ...
    printk("FUSE_RESERVED_ODM 0-3: %08x %08x %08x %08x\n", FUSE_CHIP_REGS->FUSE_RESERVED_ODM[0], FUSE_CHIP_REGS->FUSE_RESERVED_ODM[1], FUSE_CHIP_REGS->FUSE_RESERVED_ODM[2], FUSE_CHIP_REGS->FUSE_RESERVED_ODM[3]);
    printk("FUSE_RESERVED_ODM 4-7: %08x %08x %08x %08x\n", FUSE_CHIP_REGS->FUSE_RESERVED_ODM[4], FUSE_CHIP_REGS->FUSE_RESERVED_ODM[5], FUSE_CHIP_REGS->FUSE_RESERVED_ODM[6], FUSE_CHIP_REGS->FUSE_RESERVED_ODM[7]);
    ...
    printk("FUSE_SPARE_BIT 00-03: %08x %08x %08x %08x\n", FUSE_CHIP_REGS->FUSE_SPARE_BIT[ 0], FUSE_CHIP_REGS->FUSE_SPARE_BIT[ 1], FUSE_CHIP_REGS->FUSE_SPARE_BIT[ 2], FUSE_CHIP_REGS->FUSE_SPARE_BIT[ 3]);
    printk("FUSE_SPARE_BIT 04-07: %08x %08x %08x %08x\n", FUSE_CHIP_REGS->FUSE_SPARE_BIT[ 4], FUSE_CHIP_REGS->FUSE_SPARE_BIT[ 5], FUSE_CHIP_REGS->FUSE_SPARE_BIT[ 6], FUSE_CHIP_REGS->FUSE_SPARE_BIT[ 7]);
    printk("FUSE_SPARE_BIT 08-11: %08x %08x %08x %08x\n", FUSE_CHIP_REGS->FUSE_SPARE_BIT[ 8], FUSE_CHIP_REGS->FUSE_SPARE_BIT[ 9], FUSE_CHIP_REGS->FUSE_SPARE_BIT[10], FUSE_CHIP_REGS->FUSE_SPARE_BIT[11]);
    printk("FUSE_SPARE_BIT 12-15: %08x %08x %08x %08x\n", FUSE_CHIP_REGS->FUSE_SPARE_BIT[12], FUSE_CHIP_REGS->FUSE_SPARE_BIT[13], FUSE_CHIP_REGS->FUSE_SPARE_BIT[14], FUSE_CHIP_REGS->FUSE_SPARE_BIT[15]);
    printk("FUSE_SPARE_BIT 16-19: %08x %08x %08x %08x\n", FUSE_CHIP_REGS->FUSE_SPARE_BIT[16], FUSE_CHIP_REGS->FUSE_SPARE_BIT[17], FUSE_CHIP_REGS->FUSE_SPARE_BIT[18], FUSE_CHIP_REGS->FUSE_SPARE_BIT[19]);
    printk("FUSE_SPARE_BIT 20-23: %08x %08x %08x %08x\n", FUSE_CHIP_REGS->FUSE_SPARE_BIT[20], FUSE_CHIP_REGS->FUSE_SPARE_BIT[21], FUSE_CHIP_REGS->FUSE_SPARE_BIT[22], FUSE_CHIP_REGS->FUSE_SPARE_BIT[23]);
    printk("FUSE_SPARE_BIT 24-27: %08x %08x %08x %08x\n", FUSE_CHIP_REGS->FUSE_SPARE_BIT[24], FUSE_CHIP_REGS->FUSE_SPARE_BIT[25], FUSE_CHIP_REGS->FUSE_SPARE_BIT[26], FUSE_CHIP_REGS->FUSE_SPARE_BIT[27]);
    printk("FUSE_SPARE_BIT 28-31: %08x %08x %08x %08x\n", FUSE_CHIP_REGS->FUSE_SPARE_BIT[28], FUSE_CHIP_REGS->FUSE_SPARE_BIT[29], FUSE_CHIP_REGS->FUSE_SPARE_BIT[30], FUSE_CHIP_REGS->FUSE_SPARE_BIT[31]);
}
